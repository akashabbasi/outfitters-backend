...
import { IErrors, IErrorsImport, IValidationErrorImport } from 'src/common/error/error.interface';
import { IMessage, IMessageOptions, IMessageSetOptions } from '../message.interface';
...
export class MessageService {
  ...
  async getRequestErrorsMessage(
    ...
    for (const transformer of requestErrors) {
      let children: Record<string, any>[] = transformer.children;
      let constraints: string[] = Object.keys(transformer.constraints || []);
